                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <h6 className="h6 float-left">{this.state.height} ft.</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <h6 className="h6 float-left">{this.state.weight} lbs.</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-md-6">
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        <h6 className="h6 float-left">{this.state.catchRate} %</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
